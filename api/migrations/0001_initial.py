    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contents', models.ManyToManyField(blank=True, related_name='courses', to='api.content')),
        ...
        migrations.AddField(
            model_name='content',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_contents', to='api.course'),
        ),
    ]
